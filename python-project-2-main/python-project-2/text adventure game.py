...
def Project2():
    ...
    print('''
      ...
      (_)(_|---------|""""""""|----------|
      ()()(|--------|""""""""""|_--------|
    wWuwUw|wwWWwuu|"""""""""""""|uwuwuuW|wuwwuuwu
      ''')
    ...
    while flag_me_awake:
        ...
        if cmd == CMD_FEED and "bag of dog treats" in INVENTORY and flag_tv_on and extra_treats_had == None:
            print(
                'While Trevor is distracted looking at the TV, you open the bag of treats and plop a few on the floor for him. He quickly darts over and begins eating')
                ...
                if cmd == CMD_PASSWORD1:
                    ...
                    if cmd == CMD_PASSWORD2:
                        ...
                        if cmd == CMD_PASSWORD3:
                            ...
                            safe_is_open = True
                            if fail_counter == 0 and already_awarded == False:
                            ...
                            if pantry_locked:
                                if 'pantry key' not in INVENTORY:
                                    if spam_in_pantry:
                                        ...
                                        print(
                                            f"The {red('can of spam')} in the bedroom gives you a cold stare... 'Put me in the pantry... NOW!")
                                        continue
                                else:
                                    print(f"Dangit, seems you forgot to place the {red('pantry key')} back in the safe")
                                    continue
                            else:
                                print(f"You forgot to {blue('lock')} the pantry, better hurry up and go do that before your sleep paralysis demon comes and eats your precious Spam!")
                                continue
                        else:
                            print(f"Oops, you left the pantry door open and your OCD wont let you sleep unless you {blue('close')} it")
                            continue
                    else:
                        print(f"The tv is {blue('on')} and it makes a lot of noise, you cant sleep")
                        continue
                else:
                    print(f"Your pretty sure you left the safe {blue('open')}...")
                    continue
